...
const Footer: React.FC = () => {
  const footerColumns = [
    ...
    {
      title: "Column Five",
      links: ["Link Twenty One", "Link Twenty Two", "Link Twenty Three", "Link Twenty Four", "Link Twenty Five"]
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start w-full mb-[44px] sm:mb-[66px] md:mb-[88px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 w-full lg:w-auto">
              {footerColumns.map((column, index) => (
                <div key={index} className="flex flex-col gap-[20px] sm:gap-[23px] md:gap-[26px] justify-start items-start">

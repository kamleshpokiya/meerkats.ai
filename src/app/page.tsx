    ...
    <div className="flex flex-col justify-start items-center w-full bg-global-5 overflow-x-hidden">
      ...
      <section className="w-full flex flex-row justify-start items-center">
        <div className="w-full flex flex-row gap-[19px] sm:gap-[28px] md:gap-[38px] justify-start items-start">
          ...
          />
          {/* Main Hero Content */}
          <div className="container mx-auto flex flex-col justify-start items-center flex-1 mt-[56px] sm:mt-[84px] md:mt-[112px]">
            <div className="flex flex-col justify-start items-center flex-1 px-4 sm:px-6 md:px-8 lg:px-10">
              {/* Hero Title */}
            ...
            <div className="w-full max-w-[1155px] px-4 sm:px-6 md:px-8">
              <div
                className="flex flex-row justify-center items-center w-full py-[60px] sm:py-[80px] md:py-[112px]"
                style={{
      ...
      <section className="w-full mt-[35px] sm:mt-[52px] md:mt-[70px] py-[40px] sm:py-[60px] md:pb-[80px] sm:bg-[url('/images/img_union.png')] sm:bg-[length:106%_100%] sm:bg-center">
        <div className="container w-full mx-auto flex flex-col justify-start items-center">
          ...
          <div className="max-w-[1440px] flex flex-col sm:flex-row justify-between items-start sm:items-center w-full px-4 sm:px-6 md:px-8 lg:px-10 mt-[22px] sm:mt-[33px] gap-6 sm:gap-8">
            ...
            <p className="text-[9px] sm:text-[13px] md:text-[18px] font-inter font-normal leading-[13px] sm:leading-[20px] text-left text-global-3 w-full sm:w-[46%]">
          ...
          <div className="max-w-[1440px] flex flex-col lg:flex-row gap-[30px] sm:gap-[45px] md:gap-[60px] w-full mt-[52px] sm:mt-[78px] md:mt-[104px] px-4 sm:px-6 md:px-8 lg:px-10">
            {benefitCards.map((card, index) => (
              <div
                key={index}
                className="flex flex-row gap-[12px] sm:gap-[18px] md:gap-[24px] justify-start items-start w-full lg:w-[360px] px-[8px] sm:px-[12px] md:px-[16px] py-[28px] sm:py-[42px] md:py-[56px] border border-global-3 rounded-[20px] bg-global-5 transform transition-all duration-300 ease-out hover:scale-105 hover:shadow-lg hover:border-[#f54e00] hover:shadow-[#f54e00]/20 animate-fade-in-up group"
                style={{
              ...
              >
                <img
                  src={card.icon}
                  alt="Benefit Icon"
                  className="w-[13px] md:w-[26px] h-[13px] sm:w-[19px] md:h-[26px] transform transition-all duration-300 group-hover:scale-110 group-hover:filter group-hover:brightness-110"
                />
        ...
        <FadeInAnimation delay={100} className="w-full">
          <section className="w-full flex flex-col lg:flex-row justify-start items-center py-[23px] sm:bg-[url('/images/img_6838210483869da_white_a700.svg')] bg-right bg-no-repeat">
            {/* <img
              ...
              className="w-[52px] hidden lg:block border border-[#F0F0F0] rounded-[10px] sm:w-[78px] md:w-[104px] h-[385px] sm:h-[577px] md:h-[770px]"
            /> */}
            <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 flex flex-col lg:flex-row items-center flex-1 w-full">
              <Image
      ...
      <FadeInAnimation delay={400}>
        <section className="container mx-auto w-full py-[73px] sm:py-[109px] md:py-[146px] px-4 sm:px-6 md:px-8 lg:px-10">
          <div
            ...
            <div className="flex flex-col gap-[42px] sm:gap-[63px] md:gap-[84px] justify-start flex-1">
              ...
              <div className="px-4 sm:px-6 md:px-8 lg:px-10">
                <Image
                  ...
                  alt="Discovery Call"
                  className="w-full object-cover h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] xl:h-[450px] rounded-[20px]"
                  width={500}
                  height={500}
                />
              </div>
      ...
      {/* FAQ Section */}
      <section className="w-full flex flex-row justify-center items-center py-[55px] sm:py-[82px] md:py-[110px] mt-[63px] sm:mt-[94px] md:mt-[126px] bg-global-5 px-4 sm:px-6 md:px-8 lg:px-10">
        <div className="flex flex-col gap-[35px] sm:gap-[52px] md:gap-[70px] justify-start items-center w-full max-w-[800px]">
